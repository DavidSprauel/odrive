        ...
        <div class="col-xs-12 col-sm-6 col-sm-offset-3">
            ...
            <div class="row">
                ...
                <div class="form-group {{ $errors->has('units') ? 'has-error has-feedback' : '' }} col-sm-6 col-xs-12">
                    ...
                    {{ Form::select('units', ['Kilogrammes (Kg)', 'Grammes (Gr)'], null, ['class' => 'form-control']) }}
            ...
            <div class="form-group {{ $errors->has('picture') ? 'has-error has-feedback' : '' }}">
                {{ Form::label('picture', 'Ajouter une image (max: 2Mo)', ['class' => 'control-label']) }}
                {{ Form::file('picture') }}
                <small class="text-danger pull-right">{{ $errors->first('picture') }}</small>
            </div>
